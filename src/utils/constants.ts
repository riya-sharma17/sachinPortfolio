...
export const expCards: ExperienceCard[] = [
  {
    ...
    responsibilities: [
      ...
      "Maintaining company accounts using Tally ERP 9, Tally Prime, and BUSY software.",
      "Managing purchase, sales, vouchers, and ledger entries.",
      "Ensuring statutory compliance and timely documentation.",
    ],
  },
  {
    review:
...
// ================= SERVICES (REPLACES PROJECTS) =================
export const services = [
  {
    id: 1,
    title: "GST & Income Tax Filing",
    des: "Accurate and timely GST returns and income tax filing to ensure full compliance.",
    icon: "/tax.jpeg",
  },
  {
    id: 2,
    title: "GST & UDYAM Registration",
    des: "Complete registration support for GST and UDYAM with proper documentation.",
    icon: "/razorpay.webp",
  },
  {
    id: 3,
